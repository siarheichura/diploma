...
export function ContactMe() {
  ...
  <div className={styles.contactMe}>
    ...
    <label>
      Name
      <input type="text" value={inputNameValue} onChange={onInputNameChange}  />
    </label>
    <label>
      E-mail
      <input type="text" value={inputEmailValue} onChange={onInputEmailChange} />
    </label>
    <label>
      Message
      <textarea value={inputMessageValue} onChange={onInputMessageChange}></textarea>
    </label>
